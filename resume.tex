...
\begin{rsection}
    ...
    % \begin{rlist}
    %     \ritem Worked on a team to design control algorithms enabling a quadcopter to autonomously navigate a maze
...
\begin{rsection}
    ...
    \begin{rlist}
        ...
        \ritem Wrote software libraries for digital signal processing and device interfacing
    \end{rlist}
    \vspace{5pt}
...
\rheader{SKILLS}
\begin{rsection}
    \textbf{Languages}: C++, C, Python, MATLAB, Verilog, JavaScript, HTML/CSS \\
    \textbf{Technologies}: Git, Bash Shell, SSH, Flask, Nginx \\
    \textbf{Platforms}: Ubuntu Linux, Windows 10, Raspberry Pi, Arduino \\
    \textbf{IDE}: Visual Studio, Visual Studio Code, Vim
\end{rsection}
